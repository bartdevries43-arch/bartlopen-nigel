...
const CACHE = "runcoach-nigel-17k-1-aftel";
const ASSETS = ["./","./index.html","./styles.css?v=17k-1-aftel","./app.js?v=17k-1-aftel","./coach.jpg","./coach-logo.png","./bartlopen-runcoach.png","./icon-192.png","./icon-512.png","./apple-touch-icon.png","./manifest.json"];
