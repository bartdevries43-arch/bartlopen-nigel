...
const CACHE = "runcoach-nigel-17k-1-aftel-mooi2";
const ASSETS = ["./","./index.html","./styles.css?v=17k-1-aftel-mooi2","./app.js?v=17k-1-aftel-mooi2","./coach.jpg","./coach-logo.png","./bartlopen-runcoach.png","./icon-192.png","./icon-512.png","./apple-touch-icon.png","./manifest.json"];
