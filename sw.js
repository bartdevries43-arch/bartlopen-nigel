...
const CACHE = "runcoach-nigel-antwerpen-1-koppen-rec-smal";
const ASSETS = ["./","./index.html","./styles.css?v=antwerpen-1-koppen-rec-smal","./app.js?v=antwerpen-1-koppen-rec-smal","./coach.jpg","./coach-logo.png","./bartlopen-runcoach.png","./icon-192.png","./icon-512.png","./apple-touch-icon.png","./manifest.json"];
